...
use crate::core::models::{ExecutionEvent, McpServerRef, RunLog, Step, StepResult, StepStatus, Workflow};
use crate::core::parser::{resolve_env, compute_execution_levels};
use crate::core::template::{expand_template, expand_env_vars};
use crate::error::Result;

// Delegated modules — re-export public API for backwards compatibility
pub use crate::core::notify_dispatch::{build_notification, build_notifiers_for_run, resolve_targets, resolve_retry_config, resolve_rate_limit_configs, send_notifications};
pub use crate::core::secret_env::{mask_secrets, load_secret_env, load_secret_env_strict};
...
pub(crate) struct StepOutcome {
    ...
    pub(crate) captured_vars: HashMap<String, String>,
...
mod tests {
    use super::*;
    use crate::core::models::{EnvValue, NotifyConfig, Step};
    use crate::core::notify::{RetryConfig, Severity};
